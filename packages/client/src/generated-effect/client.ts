...
const Endpoint3_3 = (raw: RawClient["server.session"]) => () =>
  raw["session.agentRunOverview"]({}).pipe(Effect.mapError(mapClientError))
...
type Endpoint3_5Request = Parameters<RawClient["server.session"]["session.agentRun"]>[0]
...
const Endpoint3_5 = (raw: RawClient["server.session"]) => (input: Endpoint3_5Input) =>
  raw["session.agentRun"]({ params: { sessionID: input["sessionID"] } }).pipe(Effect.mapError(mapClientError))
...
const adaptGroup3 = (raw: RawClient["server.session"]) => ({
  ...
  agentRunOverview: Endpoint3_3(raw),
  get: Endpoint3_4(raw),
  agentRun: Endpoint3_5(raw),
